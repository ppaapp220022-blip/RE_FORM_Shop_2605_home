...
| `Sport` | `SOCCER`, `BASEBALL`, `BASKETBALL`, `VOLLEYBALL`, `ESPORTS` |
| `Grade` | `S`, `A`, `B`, `C` |
...
```java
// 현재: 세 파일에 동일한 내용
enum Sport         { SOCCER, BASEBALL, BASKETBALL, VOLLEYBALL, ESPORTS }
enum SportType     { SOCCER, BASEBALL, BASKETBALL, VOLLEYBALL, ESPORTS }
enum SportCategory { SOCCER, BASEBALL, BASKETBALL, VOLLEYBALL, ESPORTS }
```
